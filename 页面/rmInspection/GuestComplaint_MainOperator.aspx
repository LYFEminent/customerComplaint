<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GuestComplaint_MainOperator.aspx.cs" Inherits="rmInspection_GuestComplaint_MainOperator" %>
             ...
             <tr>
                ...
                <td align="left" colspan="1" style="height: 27px; width: 100px;">
                    <asp:DropDownList ID="ddlModule" runat="server" Width="200px" 
                        DataValueField="moduleID" DataTextField="moduleName" AutoPostBack="true" OnSelectedIndexChanged="ddlModule_SelectedIndexChanged">
                    </asp:DropDownList>
