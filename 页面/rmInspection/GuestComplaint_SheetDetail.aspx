                ...
                <div id="tabs-1" style="margin-top: 10px;" align="center">
                    <table class="FixedGrid" border="0" cellpadding="0" cellspacing="0" style="width: 1000px; margin-top: -20px;">
                        ...
                        <tr>
                            ...
                            <td colspan="6">
                                <asp:CheckBoxList ID="radDuty" runat="server" RepeatDirection="Horizontal" DataTextField="DutyName" DataValueField="DutyID" CellPadding="10" CellSpacing="1" Font-Bold="False" Enabled="true" RepeatLayout="Flow" AutoPostBack="True" OnSelectedIndexChanged="radDuty_SelectedIndexChanged">
                                </asp:CheckBoxList>
                            </td>
                            <td colspan="3">
